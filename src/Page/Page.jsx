...
export default function Page() {
    ...
    useEffect(() => {
        ...
        gsap.to(".first-img", {
            clipPath: " polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)", scrollTrigger: {
                trigger: ".first-img",

            }
        })
        gsap.to(".italic", {
            opacity: 1, delay: 1.1, scrollTrigger: {
                trigger: ".italic"
            }
        })
        gsap.to(".first-cont-img", {
            duration: 1.1, clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)", duration: 1.1, scrollTrigger: {
                trigger: ".first-cont-img"
            }
        })
        gsap.to(".second-cont-img", {
            duration: 1.2, clipPath: "polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)", scrollTrigger: {
                trigger: ".second-cont-img"
            }
        })
        gsap.to(".second-cont-h1", {
            opacity: 1, y: 10, scrollTrigger: {
                trigger: ".second-cont-h1"
            }
        })
        gsap.to(".h1-cara", {
            delay: 1.3, duration: 1.2, opacity: 1, clipPath: "polygon(0% 100%, 100% 100%, 100% 0%, 0% 0%)", scrollTrigger: {
                trigger: ".h1-cara"
            }
        })
